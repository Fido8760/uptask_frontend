...
export default function ProjectTeamView() {
    ...
    if(data) return (
        <>
            ...
            <p className=" text-2xl font-light text-gray-500 mt-5">Aministra el equipo de trabajo para este proyecto</p>
            <nav className="my-5 flex gap-3">
                ...
                <Link
                    ...
                    className=" bg-fuchsia-600 hover:bg-fuchsia-700 px-10 py-3 text-white text-xl font-bold cursor-pointer transition-colors uppercase"
